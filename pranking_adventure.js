...
switch (user) {
    ...
    case 'GLITTER':
        ...
        if (counterAttack != "YES") {
            ...
            console.log("Get em! Glitter goes flying in your carefully calculated counter attack and dozens of screaming girls are wiping glitter from their glisenting faces! Time to run!");
        }
        else {
        ...
        break;
    default :
        console.log("Good idea but you don't have the resources for that one.")
}